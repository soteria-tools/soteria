...
and BitVec : BitVec = struct
  ...
  let rec add ?(checked = false) v1 v2 =
    ...
    | ( Binop (Mul true, ({ node = { kind = BitVec l1; _ }; _ } as v_l1), r1),
        Binop (Mul true, ({ node = { kind = BitVec l2; _ }; _ } as v_l2), r2) )
    | ( Binop (Mul true, r1, ({ node = { kind = BitVec l1; _ }; _ } as v_l1)),
        Binop (Mul true, ({ node = { kind = BitVec l2; _ }; _ } as v_l2), r2) )
    | ( Binop (Mul true, r1, ({ node = { kind = BitVec l1; _ }; _ } as v_l1)),
        Binop (Mul true, r2, ({ node = { kind = BitVec l2; _ }; _ } as v_l2)) )
    | ( Binop (Mul true, ({ node = { kind = BitVec l1; _ }; _ } as v_l1), r1),
        Binop (Mul true, r2, ({ node = { kind = BitVec l2; _ }; _ } as v_l2)) )
