...
type t = {
  ...
  no_compile : bool;
      [@docs "FRONTEND OPTIONS"] [@make.default false] [@names [ "no-compile" ]]
  ...
  target : string option;
      [@docs "FRONTEND OPTIONS"] [@names [ "target" ]] [@env "TARGET"]
  ...
  polymorphic : bool;
      ...
      (** Whether compilation (and thus analysis) should be done on polymorphic
          ...
          substituted). *)
  output_crate : bool;
      [@docs "OUTPUT OPTIONS"] [@make.default false] [@names [ "output-crate" ]]
  ...
  sysroot : string option;
      [@docs "FRONTEND OPTIONS"] [@names [ "sysroot" ]] [@env "RUST_SYSROOT"]
      (** The sysroot to use for compilation. If not provided, the default
          sysroot is used. *)
  test : string option; [@docs "FRONTEND OPTIONS"] [@names [ "test" ]]
  ...
  (* Plugins *)
  with_kani : bool;
      [@docs "PLUGINS OPTIONS"] [@make.default false] [@names [ "kani" ]]
      (** Use the Kani library *)
  with_miri : bool;
      [@docs "PLUGINS OPTIONS"] [@make.default false] [@names [ "miri" ]]
      (** Use the Miri library *)
  (* Printing settings *)
  filter : (Str.regexp[@conv Cmdliner_helpers.regex]) list;
      [@docs "FRONTEND OPTIONS"] [@default []] [@optall] [@names [ "filter" ]]
  ...
  exclude : (Str.regexp[@conv Cmdliner_helpers.regex]) list;
      [@docs "FRONTEND OPTIONS"] [@default []] [@optall] [@names [ "exclude" ]]
      (** Filter the entrypoints to exclude, by name. If empty, no entrypoints
          ...
          Opposite of --filter. *)
  print_summary : bool;
      [@docs "OUTPUT OPTIONS"] [@make.default false] [@names [ "summary" ]]
  ...
  provenance : (provenance[@conv provenance_cmdliner_conv ()]);
      [@docs "ANALYSIS OPTIONS"] [@default Permissive] [@names [ "provenance" ]]
  ...
  step_fuel : int option;
      [@docs "ANALYSIS OPTIONS"] [@names [ "step-fuel" ]] [@env "STEP_FUEL"]
  ...
  branch_fuel : int option;
      [@docs "ANALYSIS OPTIONS"] [@names [ "branch-fuel" ]] [@env "BRANCH_FUEL"]
