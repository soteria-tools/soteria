...
module M (StateM : State.StateM.S) = struct
  module type Impl = sig
    ...
    val simd_add : t:Types.ty -> x:rust_val -> y:rust_val -> rust_val ret
    ...
    val simd_and : t:Types.ty -> x:rust_val -> y:rust_val -> rust_val ret
    ...
    val simd_as : t:Types.ty -> u:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_bitmask : t:Types.ty -> u:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_bitreverse : t:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_bswap : t:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_carryless_mul :
      t:Types.ty -> a:rust_val -> b:rust_val -> rust_val ret
    ...
    val simd_cast : t:Types.ty -> u:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_cast_ptr : t:Types.ty -> u:Types.ty -> ptr:rust_val -> rust_val ret
    ...
    val simd_ceil : t:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_ctlz : t:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_ctpop : t:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_cttz : t:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_div : t:Types.ty -> lhs:rust_val -> rhs:rust_val -> rust_val ret
    ...
    val simd_expose_provenance :
      t:Types.ty -> u:Types.ty -> ptr:rust_val -> rust_val ret
    ...
    val simd_fabs : t:Types.ty -> x:rust_val -> rust_val ret

    (** {@markdown[
          `T` must be a vector of floats.
        ]} *)
    val simd_fcos : t:Types.ty -> a:rust_val -> rust_val ret

    (** {@markdown[
          `T` must be a vector of floats.
        ]} *)
    val simd_fexp : t:Types.ty -> a:rust_val -> rust_val ret

    (** {@markdown[
          `T` must be a vector of floats.
        ]} *)
    val simd_fexp2 : t:Types.ty -> a:rust_val -> rust_val ret

    (** {@markdown[
          `T` must be a vector of floats.
        ]} *)
    val simd_flog : t:Types.ty -> a:rust_val -> rust_val ret

    (** {@markdown[
          `T` must be a vector of floats.
        ]} *)
    val simd_flog10 : t:Types.ty -> a:rust_val -> rust_val ret

    (** {@markdown[
          `T` must be a vector of floats.
        ]} *)
    val simd_flog2 : t:Types.ty -> a:rust_val -> rust_val ret
    ...
    val simd_floor : t:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_fma :
      t:Types.ty -> x:rust_val -> y:rust_val -> z:rust_val -> rust_val ret

    (** {@markdown[
          `T` must be a vector of floats.
        ]} *)
    val simd_fsin : t:Types.ty -> a:rust_val -> rust_val ret
    ...
    val simd_fsqrt : t:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_funnel_shl :
      t:Types.ty -> a:rust_val -> b:rust_val -> shift:rust_val -> rust_val ret
    ...
    val simd_mul : t:Types.ty -> x:rust_val -> y:rust_val -> rust_val ret
    ...
    val simd_neg : t:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_or : t:Types.ty -> x:rust_val -> y:rust_val -> rust_val ret
    ...
    val simd_reduce_add_unordered :
      t:Types.ty -> u:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_reduce_all : t:Types.ty -> x:rust_val -> Typed.T.sbool Typed.t ret
    ...
    val simd_reduce_and : t:Types.ty -> u:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_reduce_any : t:Types.ty -> x:rust_val -> Typed.T.sbool Typed.t ret
    ...
    val simd_reduce_max : t:Types.ty -> u:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_reduce_min : t:Types.ty -> u:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_reduce_or : t:Types.ty -> u:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_reduce_xor : t:Types.ty -> u:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_rem : t:Types.ty -> lhs:rust_val -> rhs:rust_val -> rust_val ret
    ...
    val simd_round : t:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_round_ties_even : t:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_saturating_sub :
      t:Types.ty -> lhs:rust_val -> rhs:rust_val -> rust_val ret
    ...
    val simd_shl : t:Types.ty -> lhs:rust_val -> rhs:rust_val -> rust_val ret
    ...
    val simd_shr : t:Types.ty -> lhs:rust_val -> rhs:rust_val -> rust_val ret
    ...
    val simd_splat : t:Types.ty -> u:Types.ty -> value:rust_val -> rust_val ret
    ...
    val simd_sub : t:Types.ty -> lhs:rust_val -> rhs:rust_val -> rust_val ret
    ...
    val simd_trunc : t:Types.ty -> x:rust_val -> rust_val ret
    ...
    val simd_with_exposed_provenance :
      t:Types.ty -> u:Types.ty -> addr:rust_val -> rust_val ret
    ...
    val simd_xor : t:Types.ty -> x:rust_val -> y:rust_val -> rust_val ret
    ...
    val va_copy : src:full_ptr -> rust_val ret
