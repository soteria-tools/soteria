...
Test a field access through a pointer derived from ptr.sub with a symbolic index; used to error
  ...
  PC 1: ((0x0000000000000003 & V|1|) <=u 0xfffffffffffffffe) /\
        ...
        ((((((0x0000000000000003 & V|1|) <u 0x7fffffffffffffff) || (0xc000000000000004 <=u (0x0000000000000003 & V|1|))) && ((0x7fffffffffffffff <=u (0x0000000000000003 & V|1|)) || ((0x0000000000000003 & V|1|) <=u 0x0000000000000003))) && (((0x7fffffffffffffff <=u (0x0000000000000003 & V|1|)) || ((0x0000000000000003 & V|1|) <=u 0x3fffffffffffffff)) && (((0x0000000000000003 & V|1|) <u 0x7fffffffffffffff) || (0xc000000000000000 <=u (0x0000000000000003 & V|1|))))) || (0x0000000000000000 == (0xfffffffffffffffe *cks (0x0000000000000001 +cku (0x0000000000000003 & V|1|))))) /\
