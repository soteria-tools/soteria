...
Test a field access through a pointer derived from ptr.sub with a symbolic index; used to error
  ...
  PC 1: ((0x0000000000000003 & V|1|) <=u 0xfffffffffffffffe) /\
        ...
        ((((-((0x0000000000000001 +cku (0x0000000000000003 & V|1|))) <=s 0x3ffffffffffffffb) && (0xfffffffffffffffc <=s -((0x0000000000000001 +cku (0x0000000000000003 & V|1|))))) && ((0xc000000000000000 <=s -((0x0000000000000001 +cku (0x0000000000000003 & V|1|)))) && (-((0x0000000000000001 +cku (0x0000000000000003 & V|1|))) <=s 0x3fffffffffffffff))) || (0x0000000000000000 == (0x0000000000000002 *cks -((0x0000000000000001 +cku (0x0000000000000003 & V|1|)))))) /\
        ...
        (0xfffffffffffffffc <=s -((0x0000000000000001 +cku (0x0000000000000003 & V|1|)))) /\
        (-((0x0000000000000001 +cku (0x0000000000000003 & V|1|))) <s 0x0000000000000000) /\
        (-((0x0000000000000001 +cku (0x0000000000000003 & V|1|))) <=s 0xffffffffffffffff) /\
        ((0xfffffffffffffffe <=s -((0x0000000000000001 +cku (0x0000000000000003 & V|1|)))) || (-((0x0000000000000001 +cku (0x0000000000000003 & V|1|))) <=s 0xfffffffffffffffd)) /\
        (-((0x0000000000000001 +cku (0x0000000000000003 & V|1|))) <=s 0xfffffffffffffffd) /\
        ((0xfffffffffffffffd <=s -((0x0000000000000001 +cku (0x0000000000000003 & V|1|)))) || (-((0x0000000000000001 +cku (0x0000000000000003 & V|1|))) <=s 0xfffffffffffffffc)) /\
        (-((0x0000000000000001 +cku (0x0000000000000003 & V|1|))) <=s 0xfffffffffffffffc) /\
  ...
  PC 3: ((0x0000000000000003 & V|1|) <=u 0xfffffffffffffffe) /\
        ...
        (-((0x0000000000000001 +cku (0x0000000000000003 & V|1|))) <=s 0xffffffffffffffff) /\
        ((0xfffffffffffffffe <=s -((0x0000000000000001 +cku (0x0000000000000003 & V|1|)))) || (-((0x0000000000000001 +cku (0x0000000000000003 & V|1|))) <=s 0xfffffffffffffffd)) /\
        (0xfffffffffffffffd <s -((0x0000000000000001 +cku (0x0000000000000003 & V|1|)))) /\
        ((0xffffffffffffffff <=s -((0x0000000000000001 +cku (0x0000000000000003 & V|1|)))) || (-((0x0000000000000001 +cku (0x0000000000000003 & V|1|))) <=s 0xfffffffffffffffe)) /\
        (0xfffffffffffffffe <=s -((0x0000000000000001 +cku (0x0000000000000003 & V|1|)))) /\
        (-((0x0000000000000001 +cku (0x0000000000000003 & V|1|))) <=s 0xfffffffffffffffe) /\
