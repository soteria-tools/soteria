...
Test kani::slice::any_slice_of_array
  ...
  PC: 
    (0 == V|0|) /\ (0 == V|0|) /\ !(((0 == V|0|) && (V|0| == -1))) /\
    !(((-2 <= V|0|) && (V|0| <= -2))) /\ !(((V|0| < -1) && (-2 < V|0|))) /\
    !(((0 == V|0|) && (V|0| == -2))) /\ (-2 <= V|0|) /\ (2 < (V|1| - V|0|)) /\
    (0 == V|0|) /\ (0 == V|0|) /\ (V|0| <= 0) /\ (0 <= V|0|) /\
    !(((0 == V|0|) && (1 == V|0|))) /\ !(((-1 <= V|0|) && (V|0| <= -1))) /\
    !(((V|0| < 0) && (-1 < V|0|))) /\ !(((1 == V|0|) && (V|0| == -1))) /\
    (-1 <= V|0|) /\ (V|0| <= 1) /\ (1 < (V|1| - V|0|)) /\ (0 == V|0|) /\
    (0 == V|0|) /\ (V|0| <= 0) /\ (0 <= V|0|) /\
    !(((0 < V|0|) && (V|0| < 1))) /\ !(((2 == V|0|) && (0 == V|0|))) /\
    (V|0| <= 2) /\ (0 < (V|1| - V|0|)) /\ ((V|1| - V|0|) <= 3) /\
    (0 <= (V|1| - V|0|)) /\ (V|0| <= V|1|) /\ (0 <= V|0|) /\ (V|1| <= 3) /\
    (V|0| <= V|1|) /\ (V|1| <= 3) /\ (V|1| <= 0xffffffffffffffff) /\
    (0 <= V|1|) /\ (V|0| <= 0xffffffffffffffff) /\ (0 <= V|0|)
  
  PC: 
    ((V|1| - V|0|) <= 1) /\ (1 == V|0|) /\ (1 == V|0|) /\ (1 <= V|0|) /\
    (V|0| <= 1) /\ !(((1 < V|0|) && (V|0| < 2))) /\
    !(((2 == V|0|) && (1 == V|0|))) /\ !(((0 <= V|0|) && (V|0| <= 0))) /\
    !(((0 < V|0|) && (V|0| < 1))) /\ !(((2 == V|0|) && (0 == V|0|))) /\
    (V|0| <= 2) /\ (0 < (V|1| - V|0|)) /\ ((V|1| - V|0|) <= 3) /\
    (0 <= (V|1| - V|0|)) /\ (V|0| <= V|1|) /\ (0 <= V|0|) /\ (V|1| <= 3) /\
    (V|0| <= V|1|) /\ (V|1| <= 3) /\ (V|1| <= 0xffffffffffffffff) /\
  ...
  PC: 
    ...
    !(((0 == V|0|) && (1 == V|0|))) /\ !(((-1 <= V|0|) && (V|0| <= -1))) /\
    !(((V|0| < 0) && (-1 < V|0|))) /\ !(((1 == V|0|) && (V|0| == -1))) /\
    (-1 <= V|0|) /\ (1 < (V|1| - V|0|)) /\ (1 == V|0|) /\ (1 == V|0|) /\
    (1 <= V|0|) /\ (V|0| <= 1) /\ !(((1 < V|0|) && (V|0| < 2))) /\
    !(((2 == V|0|) && (1 == V|0|))) /\ !(((0 <= V|0|) && (V|0| <= 0))) /\
    !(((0 < V|0|) && (V|0| < 1))) /\ !(((2 == V|0|) && (0 == V|0|))) /\
    (V|0| <= 2) /\ (0 < (V|1| - V|0|)) /\ ((V|1| - V|0|) <= 3) /\
    (0 <= (V|1| - V|0|)) /\ (V|0| <= V|1|) /\ (0 <= V|0|) /\ (V|1| <= 3) /\
  ...
  PC: 
    ((V|1| - V|0|) <= 1) /\ (2 == V|0|) /\ (2 == V|0|) /\
    !(((V|0| <= 1) && (1 <= V|0|))) /\ !(((1 < V|0|) && (V|0| < 2))) /\
    !(((2 == V|0|) && (1 == V|0|))) /\ !(((0 <= V|0|) && (V|0| <= 0))) /\
    !(((0 < V|0|) && (V|0| < 1))) /\ !(((2 == V|0|) && (0 == V|0|))) /\
    (V|0| <= 2) /\ (0 < (V|1| - V|0|)) /\ ((V|1| - V|0|) <= 3) /\
    (0 <= (V|1| - V|0|)) /\ (V|0| <= V|1|) /\ (0 <= V|0|) /\ (V|1| <= 3) /\
