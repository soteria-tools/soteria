...
Test kani::vec::any_vec
  ...
  PC 2: (extract[0-1](V|18|) == 0b00) /\ (V|1| == 0x000000000000000f) /\
        ...
        (V|19| <=u 0x7fffffffffffffc2) /\ (0x0000000000000004 <=u V|20|) /\
  ...
  PC 3: (extract[0-1](V|18|) == 0b00) /\ (V|1| == 0x000000000000000e) /\
        ...
        (V|18| <=u 0x7fffffffffffffbe) /\ (0x0000000000000004 <=u V|19|) /\
        (V|19| <=u 0x7fffffffffffffc6) /\ (0x0000000000000004 <=u V|20|) /\
  ...
  PC 4: (extract[0-1](V|18|) == 0b00) /\ (V|1| == 0x000000000000000d) /\
        ...
        (V|18| <=u 0x7fffffffffffffbe) /\ (0x0000000000000004 <=u V|19|) /\
        (V|19| <=u 0x7fffffffffffffca) /\ (0x0000000000000004 <=u V|20|) /\
  ...
  PC 5: (extract[0-1](V|18|) == 0b00) /\ (V|1| == 0x000000000000000c) /\
        ...
        (V|18| <=u 0x7fffffffffffffbe) /\ (0x0000000000000004 <=u V|19|) /\
        (V|19| <=u 0x7fffffffffffffce) /\ (0x0000000000000004 <=u V|20|) /\
  ...
  PC 6: (extract[0-1](V|18|) == 0b00) /\ (V|1| == 0x000000000000000b) /\
        ...
        (V|18| <=u 0x7fffffffffffffbe) /\ (0x0000000000000004 <=u V|19|) /\
        (V|19| <=u 0x7fffffffffffffd2) /\ (0x0000000000000004 <=u V|20|) /\
  ...
  PC 7: (extract[0-1](V|18|) == 0b00) /\ (V|1| == 0x000000000000000a) /\
        ...
        (V|18| <=u 0x7fffffffffffffbe) /\ (0x0000000000000004 <=u V|19|) /\
        (V|19| <=u 0x7fffffffffffffd6) /\ (0x0000000000000004 <=u V|20|) /\
  ...
  PC 8: (extract[0-1](V|18|) == 0b00) /\ (V|1| == 0x0000000000000009) /\
        ...
        (V|18| <=u 0x7fffffffffffffbe) /\ (0x0000000000000004 <=u V|19|) /\
        (V|19| <=u 0x7fffffffffffffda) /\ (0x0000000000000004 <=u V|20|) /\
        (V|20| <=u 0x7fffffffffffffda)
  PC 9: (extract[0-1](V|18|) == 0b00) /\ (0x0000000000000008 == V|1|) /\
        (0b00 == extract[0-1](V|19|)) /\ (0b00 == extract[0-1](V|20|)) /\
        (0x0000000000000008 == V|1|) /\ (0x0000000000000004 <=u V|18|) /\
        (V|18| <=u 0x7fffffffffffffbe) /\ (0x0000000000000004 <=u V|19|) /\
        (V|19| <=u 0x7fffffffffffffde) /\ (0x0000000000000004 <=u V|20|) /\
  ...
  PC 10: (extract[0-1](V|18|) == 0b00) /\ (V|1| == 0x0000000000000007) /\
         ...
         (V|18| <=u 0x7fffffffffffffbe) /\ (0x0000000000000004 <=u V|19|) /\
         (V|19| <=u 0x7fffffffffffffe2) /\ (0x0000000000000004 <=u V|20|) /\
  ...
  PC 11: (extract[0-1](V|18|) == 0b00) /\ (V|1| == 0x0000000000000006) /\
         ...
         (V|18| <=u 0x7fffffffffffffbe) /\ (0x0000000000000004 <=u V|19|) /\
         (V|19| <=u 0x7fffffffffffffe6) /\ (0x0000000000000004 <=u V|20|) /\
  ...
  PC 12: (extract[0-1](V|18|) == 0b00) /\ (V|1| == 0x0000000000000005) /\
         ...
         (V|18| <=u 0x7fffffffffffffbe) /\ (0x0000000000000004 <=u V|19|) /\
         (V|19| <=u 0x7fffffffffffffea) /\ (0x0000000000000004 <=u V|20|) /\
  ...
  PC 13: (extract[0-1](V|18|) == 0b00) /\ (V|1| == 0x0000000000000004) /\
         ...
         (V|18| <=u 0x7fffffffffffffbe) /\ (0x0000000000000004 <=u V|19|) /\
         (V|19| <=u 0x7fffffffffffffee) /\ (0x0000000000000004 <=u V|20|) /\
  ...
  PC 14: (extract[0-1](V|18|) == 0b00) /\ (V|1| == 0x0000000000000003) /\
         ...
         (V|18| <=u 0x7fffffffffffffbe) /\ (0x0000000000000004 <=u V|19|) /\
         (V|19| <=u 0x7ffffffffffffff2) /\ (0x0000000000000004 <=u V|20|) /\
  ...
  PC 15: (extract[0-1](V|18|) == 0b00) /\ (V|1| == 0x0000000000000002) /\
         ...
         (V|18| <=u 0x7fffffffffffffbe) /\ (0x0000000000000004 <=u V|19|) /\
         (V|19| <=u 0x7ffffffffffffff6) /\ (0x0000000000000004 <=u V|20|) /\
  ...
  PC 16: (extract[0-1](V|18|) == 0b00) /\ (0x0000000000000001 == V|1|) /\
         ...
         (V|18| <=u 0x7fffffffffffffbe) /\ (0x0000000000000004 <=u V|19|) /\
         (V|19| <=u 0x7ffffffffffffffa) /\ (0x0000000000000004 <=u V|20|) /\
         (V|20| <=u 0x7ffffffffffffffa)
  PC 17: (extract[0-1](V|18|) == 0b00) /\ (0x0000000000000010 == V|1|) /\
         (0x0000000000000010 == V|1|) /\ (0x0000000000000004 <=u V|18|) /\
         (V|18| <=u 0x7fffffffffffffbe)
