...
Test kani::slice::any_slice_of_array
  ...
  PC: 
    ((V|1| - V|0|) <= 1) /\ (0 == V|0|) /\ (0 == V|0|) /\ ((4 * V|0|) <= 0) /\
    (0 <= (4 * V|0|)) /\ !(((0 < (4 * V|0|)) && ((4 * V|0|) < 4))) /\
    !(((2 == V|0|) && (0 == V|0|))) /\ (0 <= (4 * V|0|)) /\
  ...
  PC: 
    ((V|1| - V|0|) <= 2) /\ (0 == V|0|) /\ (0 == V|0|) /\ ((4 * V|0|) <= 0) /\
    (0 <= (4 * V|0|)) /\ !(((0 == V|0|) && (1 == V|0|))) /\
    !(((-4 <= (4 * V|0|)) && ((4 * V|0|) <= -4))) /\
    !((((4 * V|0|) < 0) && (-4 < (4 * V|0|)))) /\
    !(((1 == V|0|) && (V|0| == -1))) /\ (-4 <= (4 * V|0|)) /\
    ((4 * V|0|) <= 4) /\ (1 < (V|1| - V|0|)) /\ (0 == V|0|) /\ (0 == V|0|) /\
    ((4 * V|0|) <= 0) /\ (0 <= (4 * V|0|)) /\
    !(((0 < (4 * V|0|)) && ((4 * V|0|) < 4))) /\
    !(((2 == V|0|) && (0 == V|0|))) /\ (0 <= (4 * V|0|)) /\
    ((4 * V|0|) <= 8) /\ (0 < (V|1| - V|0|)) /\ ((V|1| - V|0|) <= 3) /\
