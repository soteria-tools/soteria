...
Test kani::slice::any_slice_of_array
  ...
  PC 1: (V|1| <=u V|2|) /\ (0x0000000000000000 == V|1|) /\
        (0x0000000000000000 == V|2|) /\ (0x0000000000000000 == V|1|) /\
        (0x0000000000000000 == V|2|)
  PC 2: (V|1| <=u V|2|) /\ (0x0000000000000000 == V|1|) /\
        (0x0000000000000003 == V|2|) /\ (0x0000000000000000 == V|1|) /\
        (0x0000000000000003 == V|2|)
  PC 3: (V|1| <=u V|2|) /\ (0x0000000000000000 == V|1|) /\
        (V|2| == 0x0000000000000002) /\ (0x0000000000000000 == V|1|) /\
        (V|2| == 0x0000000000000002)
  PC 4: (V|1| <=u V|2|) /\ (0x0000000000000000 == V|1|) /\
        (0x0000000000000001 == V|2|) /\ (0x0000000000000000 == V|1|) /\
        (0x0000000000000001 == V|2|)
  PC 5: (V|1| <=u V|2|) /\ ((V|2| -cku V|1|) <=u 0x3fffffffffffffff) /\
        (0x0000000000000001 <=u V|1|) /\ (V|1| <=u 0x0000000000000003) /\
        (V|2| <=u 0x0000000000000003) /\
        (0x0000000000000000 == (V|2| -cku V|1|))
  PC 6: (V|1| <=u V|2|) /\ ((V|2| -cku V|1|) <=u 0x3fffffffffffffff) /\
        (0x0000000000000000 != (V|2| -cku V|1|)) /\
        ((V|2| -cku V|1|) <u 0x2000000000000000) /\
        ((V|2| -cku V|1|) <=u 0x0000000000000003) /\
        (0x0000000000000000 <s (V|2| -cku V|1|)) /\
        (V|1| == 0x0000000000000002) /\ (V|2| <=u 0x0000000000000003) /\
        (V|1| == 0x0000000000000002)
  PC 7: (V|1| <=u V|2|) /\ ((V|2| -cku V|1|) <=u 0x3fffffffffffffff) /\
        (0x0000000000000000 != (V|2| -cku V|1|)) /\
        ((V|2| -cku V|1|) <u 0x2000000000000000) /\
        ((V|2| -cku V|1|) <=u 0x0000000000000003) /\
        (0x0000000000000000 <s (V|2| -cku V|1|)) /\
        (0x0000000000000001 == V|1|) /\ (0x0000000000000003 == V|2|) /\
        (0x0000000000000001 == V|1|) /\ (0x0000000000000003 == V|2|)
  PC 8: (V|1| <=u V|2|) /\ ((V|2| -cku V|1|) <=u 0x3fffffffffffffff) /\
        (0x0000000000000000 != (V|2| -cku V|1|)) /\
        ((V|2| -cku V|1|) <u 0x2000000000000000) /\
        ((V|2| -cku V|1|) <=u 0x0000000000000003) /\
        (0x0000000000000000 <s (V|2| -cku V|1|)) /\
        (0x0000000000000001 == V|1|) /\ (V|2| <=u 0x0000000000000002) /\
...
Test kani::vec::any_vec
  ...
  PC 1: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
        (0x0000000000000004 <=u (V|18| ++ 0b00)) /\
        (0x0000000000000000 == V|1|) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
        (0x0000000000000000 == V|1|)
  PC 2: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
        (0x0000000000000004 <=u (V|18| ++ 0b00)) /\
        (V|1| == 0x0000000000000010) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
        (V|1| == 0x0000000000000010)
  PC 3: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
        (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
       (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7ffffffffffffffb) /\
        (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
        (0x0000000000000001 == V|1|) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|19|) /\
        (0x0000000000000001 == V|1|)
  PC 4: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
        (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
       (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7ffffffffffffff7) /\
        (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
        (V|1| == 0x0000000000000002) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|19|) /\
        (V|1| == 0x0000000000000002)
  PC 5: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
        (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
       (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7ffffffffffffff3) /\
        (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
        (V|1| == 0x0000000000000003) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|19|) /\
        (V|1| == 0x0000000000000003)
  PC 6: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
        (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
       (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7fffffffffffffef) /\
        (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
        (V|1| == 0x0000000000000004) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|19|) /\
        (V|1| == 0x0000000000000004)
  PC 7: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
        (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
       (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7fffffffffffffeb) /\
        (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
        (V|1| == 0x0000000000000005) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|19|) /\
        (V|1| == 0x0000000000000005)
  PC 8: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
        (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
       (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7fffffffffffffe7) /\
        (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
        (V|1| == 0x0000000000000006) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|19|) /\
        (V|1| == 0x0000000000000006)
  PC 9: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
        (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
       (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7fffffffffffffe3) /\
        (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
        (V|1| == 0x0000000000000007) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
        (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|19|) /\
        (V|1| == 0x0000000000000007)
  PC 10: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
         (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
        (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7fffffffffffffdf) /\
         (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
         (V|1| == 0x0000000000000008) /\
         (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
         (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|19|) /\
         (V|1| == 0x0000000000000008)
  PC 11: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
         (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
        (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7fffffffffffffdb) /\
         (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
         (V|1| == 0x0000000000000009) /\
         (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
         (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|19|) /\
         (V|1| == 0x0000000000000009)
  PC 12: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
         (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
        (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7fffffffffffffd7) /\
         (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
         (V|1| == 0x000000000000000a) /\
         (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
         (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|19|) /\
         (V|1| == 0x000000000000000a)
  PC 13: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
         (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
        (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7fffffffffffffd3) /\
         (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
         (V|1| == 0x000000000000000b) /\
         (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
         (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|19|) /\
         (V|1| == 0x000000000000000b)
  PC 14: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
         (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
        (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7fffffffffffffcf) /\
         (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
         (V|1| == 0x000000000000000c) /\
         (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
         (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|19|) /\
         (V|1| == 0x000000000000000c)
  PC 15: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
         (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
        (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7fffffffffffffcb) /\
         (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
         (V|1| == 0x000000000000000d) /\
         (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
         (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|19|) /\
         (V|1| == 0x000000000000000d)
  PC 16: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
         (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
        (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7fffffffffffffc7) /\
         (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
         (V|1| == 0x000000000000000e) /\
         (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|18|) /\
         (0b00000000000000000000000000000000000000000000000000000000000001 <=u V|19|) /\
         (V|1| == 0x000000000000000e)
  PC 17: ((V|18| ++ 0b00) <u 0x7fffffffffffffbf) /\
         (0x0000000000000004 <=u (V|18| ++ 0b00)) /\ Distinct((V|18| ++ 0b00),
        (V|19| ++ 0b00)) /\ ((V|19| ++ 0b00) <u 0x7fffffffffffffc3) /\
         (0x0000000000000004 <=u (V|19| ++ 0b00)) /\
