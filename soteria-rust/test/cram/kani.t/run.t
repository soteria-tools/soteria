...
Test kani::slice::any_slice_of_array
  ...
  PC: 
    ...
    (V|1| <= 3) /\ (V|0| <= V|1|) /\ (0 <= V|0|) /\ (V|0| <= V|1|) /\
    (V|1| <= 3) /\ (V|1| <= 0xffffffffffffffff) /\ (0 <= V|1|) /\
    (V|0| <= 0xffffffffffffffff) /\ (0 <= V|0|)
  
  PC: 
    ((V|1| - V|0|) <= 1) /\ ((4 * V|0|) == 0) /\ ((4 * V|0|) == 0) /\
    ((4 * V|0|) <= 0) /\ (0 <= (4 * V|0|)) /\
    !((((4 * V|0|) < 4) && (0 < (4 * V|0|)))) /\
    !((((4 * V|0|) == 0) && ((4 * V|0|) == 8))) /\ (0 <= (4 * V|0|)) /\
    ((4 * V|0|) <= 8) /\ (0 < (V|1| - V|0|)) /\ ((V|1| - V|0|) <= 3) /\
    (0 <= (V|1| - V|0|)) /\ (V|1| <= 3) /\ (V|0| <= V|1|) /\ (0 <= V|0|) /\
    (V|0| <= V|1|) /\ (V|1| <= 3) /\ (V|1| <= 0xffffffffffffffff) /\
    (0 <= V|1|) /\ (V|0| <= 0xffffffffffffffff) /\ (0 <= V|0|)
  
  PC: 
    ((V|1| - V|0|) <= 2) /\ ((4 * V|0|) == 0) /\ ((4 * V|0|) == 0) /\
    ((4 * V|0|) <= 0) /\ (0 <= (4 * V|0|)) /\
    !((((4 * V|0|) == 0) && ((4 * V|0|) == 4))) /\
    !(((-4 <= (4 * V|0|)) && ((4 * V|0|) <= -4))) /\
    !((((4 * V|0|) < 0) && (-4 < (4 * V|0|)))) /\
    !((((4 * V|0|) == -4) && ((4 * V|0|) == 4))) /\ (-4 <= (4 * V|0|)) /\
    ((4 * V|0|) <= 4) /\ (1 < (V|1| - V|0|)) /\ ((4 * V|0|) == 0) /\
    ((4 * V|0|) == 0) /\ ((4 * V|0|) <= 0) /\ (0 <= (4 * V|0|)) /\
    !((((4 * V|0|) < 4) && (0 < (4 * V|0|)))) /\
    !((((4 * V|0|) == 0) && ((4 * V|0|) == 8))) /\ (0 <= (4 * V|0|)) /\
    ((4 * V|0|) <= 8) /\ (0 < (V|1| - V|0|)) /\ ((V|1| - V|0|) <= 3) /\
    (0 <= (V|1| - V|0|)) /\ (V|1| <= 3) /\ (V|0| <= V|1|) /\ (0 <= V|0|) /\
  ...
  PC: 
    ...
    !(((-8 <= (4 * V|0|)) && ((4 * V|0|) <= -8))) /\
    !((((4 * V|0|) < -4) && (-8 < (4 * V|0|)))) /\
    !((((4 * V|0|) == -8) && ((4 * V|0|) == 0))) /\ (-8 <= (4 * V|0|)) /\
    (2 < (V|1| - V|0|)) /\ ((4 * V|0|) == 0) /\ ((4 * V|0|) == 0) /\
    ((4 * V|0|) <= 0) /\ (0 <= (4 * V|0|)) /\
    !((((4 * V|0|) == 0) && ((4 * V|0|) == 4))) /\
    !(((-4 <= (4 * V|0|)) && ((4 * V|0|) <= -4))) /\
    !((((4 * V|0|) < 0) && (-4 < (4 * V|0|)))) /\
  ...
  PC: 
    ((V|1| - V|0|) <= 2) /\ ((4 * V|0|) == 4) /\ ((4 * V|0|) == 4) /\
    !((((4 * V|0|) == 0) && ((4 * V|0|) == 4))) /\
    !(((-4 <= (4 * V|0|)) && ((4 * V|0|) <= -4))) /\
    !((((4 * V|0|) < 0) && (-4 < (4 * V|0|)))) /\
    !((((4 * V|0|) == -4) && ((4 * V|0|) == 4))) /\ (-4 <= (4 * V|0|)) /\
    (1 < (V|1| - V|0|)) /\ ((4 * V|0|) == 4) /\ ((4 * V|0|) == 4) /\
    ((4 * V|0|) <= 4) /\ (4 <= (4 * V|0|)) /\
    !((((4 * V|0|) < 8) && (4 < (4 * V|0|)))) /\
    !((((4 * V|0|) == 4) && ((4 * V|0|) == 8))) /\
    !(((0 <= (4 * V|0|)) && ((4 * V|0|) <= 0))) /\
