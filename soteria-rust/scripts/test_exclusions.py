...
KNOWN_ISSUES = {
    ...
    "pass/issues/issue-3200-packed-field-offset.rs": "We don't handle repr(packed) with an unsized tail",
    "pass/issues/issue-3200-packed2-field-offset.rs": "We don't handle repr(packed) with an unsized tail",
