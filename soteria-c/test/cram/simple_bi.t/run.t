...
if%sat1 had the wrong semantics and would not correctly backtrack.
  ...
  Summaries for test_561:
    Analysed {
      ...
      { args = [V|1|; &(V|2|, V|3|)]; pre = [];
        pc = [(0 == V|2|); (V|1| <= 0x7fffffff); (1 <= V|1|); (0 == V|2|)];
        post = { heap = []; globs = [] };
        ret =
        (Error (Null pointer dereference,
    ...
    Analysed {
      ...
      { args = [V|1|; &(V|2|, V|3|)];
        ...
        pc =
        [(0 != V|2|); (V|1| <= 0x7fffffff); (1 <= V|1|); (V|4| <= 0x7fffffff);
          (-0x80000000 <= V|4|)];
        post =
        { heap =
          [(V|2|,
  ...
  Summaries for test_561:
    ...
    Analysed {
      raw =
      { args = [&(V|1|, V|2|); V|3|]; pre = [];
        pc = [(0 == V|1|); (0 == V|1|); (V|3| <= 0x7fffffff); (1 <= V|3|)];
        post = { heap = []; globs = [] };
        ret =
        (Error (Null pointer dereference,
    ...
    Analysed {
      ...
      { args = [&(V|1|, V|2|); V|3|];
        ...
        pc =
        [(0 != V|1|); (1 == V|3|); (1 == V|3|); (V|4| <= 0x7fffffff);
          (-0x80000000 <= V|4|)];
        post =
        { heap =
          [(V|1|,
    ...
    Analysed {
      ...
      { args = [&(V|1|, V|2|); V|3|];
        ...
        pc =
        [(0 != V|1|); (V|3| == 2); (V|3| == 2); (V|4| <= 0x7fffffff);
          (-0x80000000 <= V|4|); (V|5| <= 0x7fffffff); (-0x80000000 <= V|5|)];
        post =
        { heap =
          [(V|1|,
            { node =
    ...
    Analysed {
      ...
      { args = [&(V|1|, V|2|); V|3|];
        ...
        pc =
        [(0 != V|1|); (V|3| == 3); (V|3| == 3); (V|4| <= 0x7fffffff);
          (-0x80000000 <= V|4|); (V|5| <= 0x7fffffff); (-0x80000000 <= V|5|);
          (V|6| <= 0x7fffffff); (-0x80000000 <= V|6|)];
        post =
        { heap =
          [(V|1|,
            { node =
