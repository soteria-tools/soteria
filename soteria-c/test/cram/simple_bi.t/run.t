  $ soteria-c gen-summaries load.c --no-ignore-parse-failures
  Summaries for f_484:
  ...
  $ soteria-c gen-summaries manifest.c --no-ignore-parse-failures
...
if%sat1 had the wrong semantics and would not correctly backtrack.
  $ soteria-c gen-summaries if_sat_one_ok.c --no-ignore-parse-failures
