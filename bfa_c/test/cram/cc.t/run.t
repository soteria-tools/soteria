  ...
  Symex terminated with the following outcomes:
    [Ok: (0,
          [(V|0|, Freed); (V|1|, [Uninit {offset = 0; len = 24}; Bound 24]);
           ...
           (V|5|,
            [TypedVal {offset = 0; v = { ty = size_t; v = 10 }};
             TypedVal {offset = 8; v = { ty = size_t; v = 16 }};
             TypedVal {offset = 16; v = { ty = void**; v = &(V|31|, 0) }};
             Bound 24]);
           ...
           (V|30|, Freed);
           (V|31|,
            [TypedVal {offset = 0; v = { ty = void*; v = &(0, 0) }};
             TypedVal {offset = 8; v = { ty = void*; v = &(0, 0) }};
             TypedVal {offset = 16; v = { ty = void*; v = &(0, 0) }};
             TypedVal {offset = 24; v = { ty = void*; v = &(0, 0) }};
             TypedVal {offset = 32; v = { ty = void*; v = &(0, 0) }};
             TypedVal {offset = 40; v = { ty = void*; v = &(0, 0) }};
             TypedVal {offset = 48; v = { ty = void*; v = &(0, 0) }};
             TypedVal {offset = 56; v = { ty = void*; v = &(0, 0) }};
             TypedVal {offset = 64; v = { ty = void*; v = &(0, 0) }};
             TypedVal {offset = 72; v = { ty = void*; v = &(0, 0) }};
