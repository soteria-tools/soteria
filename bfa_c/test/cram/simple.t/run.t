...
Symbolic execution of a simple program with symbolic values that fails because of an allocation error
  ...
  Symex terminated with the following outcomes:
    [Ok: (0,
          [(V|0|, Freed);
           (V|1|,
            [TypedVal {offset = 0; v = { ty = signed int; v = 12 }};
...
Symbolic execution of a simple program with a horrible pointer indirection *&*x
  ...
  Symex terminated with the following outcomes:
    [Ok: (0,
          [(V|0|, Freed);
           (V|1|,
            [TypedVal {offset = 0; v = { ty = signed int; v = 12 }}; Bound 4])]);
     Ok: (1, [(V|0|, Freed)])]
...
Checking that memcpy works correctly
  ...
  Symex terminated with the following outcomes:
    [Ok: (1,
          [(V|0|, Freed);
           (V|1|,
            [TypedVal {offset = 0; v = { ty = signed int; v = 0 }};
             TypedVal {offset = 4; v = { ty = signed int; v = 1 }};
